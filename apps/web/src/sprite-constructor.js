...
export const componentById = {
  ...
  hat_warrior_starter: new SpriteComponent({
    id: "hat_warrior_starter",
    slot: "hat",
    layers: [makeLayer(0, 4, "/\\")],
    anchor: { pattern: "/\\", targetIndexes: [1, 1] },
    baseClass: "warrior",
  ...
  hat_mage_starter: new SpriteComponent({
    id: "hat_mage_starter",
    slot: "hat",
    layers: [makeLayer(0, 6, "/\\", "sprite-hat"), makeLayer(1, 3, "__/  \\___", "sprite-hat")],
    effects: [{ type: "shift-slot-anchors", slots: ["face", "arms", "torso", "legs"], dy: 1 }],
  ...
  hat_cowboy_starter: new SpriteComponent({
    id: "hat_cowboy_starter",
    slot: "hat",
    layers: [makeLayer(0, 3, "__/--\\___")],
    anchor: { pattern: "__/--\\___", targetIndexes: [3, 5] },
    baseClass: "cowboy",
  ...
  face_plain_starter: new SpriteComponent({
    id: "face_plain_starter",
    slot: "face",
    layers: [makeLayer(0, 2, "( ·  ·)")],
    anchor: { pattern: "( ·  ·)", targetIndexes: [2, 4] },
    stats: { hp: 0, attack: 0 },
  ...
  face_bandana_starter: new SpriteComponent({
    id: "face_bandana_starter",
    slot: "face",
    layers: [makeLayer(0, 3, ">( ·  ·)")],
    anchor: { pattern: ">( ·  ·)", targetIndexes: [3, 5] },
    baseClass: "cowboy",
  ...
  face_blessed_eyes_starter: new SpriteComponent({
    id: "face_blessed_eyes_starter",
    slot: "face",
    layers: [makeLayer(0, 4, "( ✦  ✦)")],
    anchor: { pattern: "( ✦  ✦)", targetIndexes: [2, 4] },
    stats: { hp: 0, attack: 0 },
  ...
  arms_mage_starter: new SpriteComponent({
    id: "arms_mage_starter",
    slot: "arms",
    layers: [makeLayer(0, 5, "/   \\", "sprite-main", 1)],
    anchor: { pattern: "/   \\", targetIndexes: [0, 4] },
    baseClass: "shared",
  ...
  arms_mage_mantle_top_starter: new SpriteComponent({
    id: "arms_mage_mantle_top_starter",
    slot: "arms",
    layers: [
      makeLayer(-3, 16, ".", "sprite-dust", 2),
      makeLayer(-2, 15, ".", "sprite-dust", 2),
  ...
  arms_cowboy_starter: new SpriteComponent({
    id: "arms_cowboy_starter",
    slot: "arms",
    layers: [
      makeLayer(0, 5, "| _", "sprite-main", 1),
      makeLayer(0, 8, "Г‾‾", "sprite-gun", 2),
  ...
  torso_mage_starter: new SpriteComponent({
    id: "torso_mage_starter",
    slot: "torso",
    layers: [makeLayer(0, 4, "/_____\\")],
    anchor: { pattern: "/_____\\", targetIndexes: [2, 4] },
    baseClass: "mage",
  ...
  torso_mage_mantle_bottom_starter: new SpriteComponent({
    id: "torso_mage_mantle_bottom_starter",
    slot: "torso",
    layers: [makeLayer(0, 4, "/__/\\_\\")],
    anchor: { pattern: "/__/\\_\\", targetIndexes: [3, 4] },
    baseClass: "mage",
  ...
  torso_cowboy_starter: new SpriteComponent({
    id: "torso_cowboy_starter",
    slot: "torso",
    layers: [makeLayer(0, 4, "/+++0+\\")],
    anchor: { pattern: "/+++0+\\", targetIndexes: [2, 4] },
    baseClass: "cowboy",
  ...
  legs_boots_starter: new SpriteComponent({
    id: "legs_boots_starter",
    slot: "legs",
    layers: [makeLayer(0, 2, "/_/ \\_\\")],
    anchor: { pattern: "/_/ \\_\\", targetIndexes: [3, 3] },
    stats: { hp: 0, attack: 1 },
  ...
  legs_cowboy_boots_starter: new SpriteComponent({
    id: "legs_cowboy_boots_starter",
    slot: "legs",
    layers: [makeLayer(0, 3, "JH Hl", "sprite-leather")],
    anchor: { pattern: "JH Hl", targetIndexes: [2, 2] },
    stats: { hp: 0, attack: 0 },
  ...
  legs_brass_kneepads_starter: new SpriteComponent({
    id: "legs_brass_kneepads_starter",
    slot: "legs",
    layers: [makeLayer(0, 2, "/o/ \\o\\")],
    anchor: { pattern: "/o/ \\o\\", targetIndexes: [3, 3] },
    stats: { hp: 0, attack: 1 },
...
export const randomPoolBySlot = {
  hat: [
    ...
    "hat_warrior_crown",
    "hat_mage_halo",
    "hat_cowboy_emu_kak_raz",
  ],
  face: [
    "face_plain_starter",
    "face_bandana_starter",
    "face_blessed_eyes_starter",
    "face_plain",
    "face_bandana",
    "face_blessed_eyes",
  ],
  arms: [
    "arms_warrior_starter",
    "arms_mage_starter",
    "arms_mage_mantle_top_starter",
    "arms_cowboy_starter",
    "arms_warrior",
    "arms_mage",
    "arms_mage_mantle_top",
    "arms_cowboy",
  ],
  torso: [
    "torso_warrior_starter",
    "torso_mage_starter",
    "torso_mage_mantle_bottom_starter",
    "torso_cowboy_starter",
    "torso_warrior",
    "torso_mage",
    "torso_mage_mantle_bottom",
    "torso_cowboy",
  ],
  legs: [
    "legs_boots_starter",
    "legs_cowboy_boots_starter",
    "legs_brass_kneepads_starter",
    "legs_boots",
    "legs_cowboy_boots",
    "legs_brass_kneepads",
  ],
